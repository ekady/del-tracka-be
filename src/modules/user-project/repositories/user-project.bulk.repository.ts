...
@Injectable()
export class UserProjectBulkRepository extends DatabaseMongoBulkRepositoryAbstract<TUserProjectDocument> {
  constructor(
    @InjectModel(UserProjectEntity.name)
    private userProjectBulkModel: Model<TUserProjectDocument>,
  ) {
